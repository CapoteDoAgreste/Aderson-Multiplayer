for(i = ds_map_find_first(jogadores);!is_undefined(i); i = ds_map_find_next(jogadores,i)){
	...
	with(obj_render_player){
		...
		buffer_write(con_server_floor2.buff,buffer_s16,sock);
		buffer_write(con_server_floor2.buff,buffer_s16,x);
		buffer_write(con_server_floor2.buff,buffer_s16,y);
		buffer_write(con_server_floor2.buff,buffer_s16,sprite_index);
		buffer_write(con_server_floor2.buff,buffer_s16,image_index);
		}
	}
